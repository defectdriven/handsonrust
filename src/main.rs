...
impl State {
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(2, RED, BLACK, "Your quest has ended, loser!");
        ctx.print_color_centered(4, WHITE, BLACK,
            "Slain by a monster, your journey has come to an end.");
        ctx.print_color_centered(5, WHITE, BLACK,
                                 "The Amulet remains unclaimed and your town will be set afire!");
        ctx.print_color_centered(8, YELLOW, BLACK,
                                 "Try again?");
        ctx.print_color_centered(9, GREEN, BLACK,
                                 "Enter a quarter (or press 1) to play again.");
